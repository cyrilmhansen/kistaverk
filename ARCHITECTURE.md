...
- **Sensor logger:** Rust screen drives Start/Stop/Share UI; Kotlin collects sensors on a background thread, writes CSV to app storage, updates status/path bindings back to Rust, and cleans up on back/reset.
