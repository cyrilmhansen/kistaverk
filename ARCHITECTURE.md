...
- **Text tools:** Rust-side text utilities include casing, wrap/trim, counts, Base64, and URL encode/decode; implemented with std code paths (no extra deps) and rendered via JSON buttons.
