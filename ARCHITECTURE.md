...
- **Text viewer:** Rust drives a text/CSV preview screen (256 KB cap) with a file picker. Kotlin filters picker MIME types to text/CSV, opens a detached FD, and relays path + fd to Rust for safe UTF-8/lossey decoding with inline error reporting.
